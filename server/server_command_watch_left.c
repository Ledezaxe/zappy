/*
** server_command_watch_left.c for zappy in /home/zheness/repositories/zappy
** 
** Made by Max Prudhomme
** Login   <prudho_m@epitech.net>
** 
** Started on  Sat Jun 28 12:51:07 2014 Max Prudhomme
** Last update Fri Jul 11 15:22:42 2014 Max Prudhomme
*/
...
int		s_look_left(t_user_list *us, t_utils *utils, t_uint *size)
{
  int		i;
  int		x;
  int		max;
